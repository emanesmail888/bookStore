...
class UserDashboardComponent extends Component
{
    public function render()
    {
        ...
        return view('livewire.user.user-dashboard-component',['orders'=>$orders,'totalCost'=>$totalCost,'totalCancelled'=>$totalCancelled,'totalPurchase'=>$totalPurchase,'totalDelivered'=>$totalDelivered])->layout('layouts.master');
    }
